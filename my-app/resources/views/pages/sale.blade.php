...
<div class="max-w-[1500px] mx-auto pt-10 pb-16 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-10 flex flex-col items-start">
        <h1 class="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-rose-700 to-rose-400 tracking-tight uppercase">
            Sale & Clearance
        </h1>
        <div class="h-1 w-24 bg-gradient-to-r from-rose-500 to-rose-700 mt-4 rounded-full"></div>
    </div>
        ...
        <div class="flex-1 min-w-0">
            ...
            @if(count($products) === 0)
                <div class="bg-white border border-zinc-100 rounded-2xl p-16 text-center">
                    ...
                    <a href="{{ route('sale') }}" class="inline-block mt-3 text-sm font-bold text-zinc-900 underline">Clear filters</a>
                </div>
            @else
