...
{{-- UPDATED: Title to reflect Women's section --}}
            ...
            <div class="p-6 flex flex-col flex-grow relative z-20 bg-white">
                ...
                <div class="flex items-end justify-between mt-auto pt-4 border-t border-zinc-100">
                    ...
                    <div class="flex flex-col items-end">
                        ...
                        {{-- Details Button --}}
                        <a href="{{ route('product.show', $product->id) }}" 
                           class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-zinc-900 text-white hover:bg-pink-600 hover:scale-110 transition-all duration-300 {{ !$inStock ? 'opacity-50 pointer-events-none cursor-not-allowed' : 'shadow-md shadow-zinc-900/20' }}"
